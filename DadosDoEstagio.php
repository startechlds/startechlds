...
<body>
    ...
    <div class="container">
            ...
            <div clas="row">
                ...
                <div class="col-12 h-auto d-inline-block" style="margin-top: 70px; background-color: rgb(175, 175, 166); height: 70%">
                    ...
                    <div class="row mt-4"> 
                        ...
                        <div class="form-group row col-3 mt-3 offset-sm-1">
                            <label for="example-datetime-local-input" class="col-2 col-form-label">Data Inicial:</label>
