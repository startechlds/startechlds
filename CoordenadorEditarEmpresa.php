...
<body>
    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-10 offset-sm-1 h-auto d-inline-block" style=" margin-top: 80px; border: 1px solid black; height: 60vh; border: 1px solid rgb(235, 217, 217); box-shadow: 1px 1px 15px 5px #968c8c;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10 offset-sm-1 mt-2">
                            ...
                            <form class="form-row" method="POST" action="php/crud_empresa.php" enctype="multipart/form-data" >
                                <?php
                                ...
                                <div class="col-11 form-group mt-4" style="display: flex; align-items: center; justify-content: space-around;">
                                ...
                                <div class="col-10 form-group" style="display: flex; align-items: center; justify-content: space-around; margin-top: 40px">
                                    ...
                                    <input style="width: 30%" type="text" id="senha" name="wpp_empresa" class="form-control formInicial" value="<?php echo $exibir->CH_WppEmpresa?>" required/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-check col-3">
                                                ...
                                                <input class="form-check-input" name="!convenio" type="checkbox" value="on" id="flexCheckDefault"> Não possui convenio<br>
                                                <label class="btn btn-primary" for="my-file-selector">
                                                    <input id="my-file-selector" type="file" class="d-none" name="doc_convenio">
                                                    Possui Convenio
                                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10 offset-sm-1 mt-2">
                                ...
                                <div class="col-10 form-group mt-4" style="display: flex; align-items: center; justify-content: space-around;">
                                    ...
                                    <label for="nome"><strong>Nome:&nbsp</strong></label>
                                    <input type="text" id="nome" name="nome_responsavel" placeholder="Nome" class="form-control formInicial" value="<?php echo $nome[0];?>"/>
                        
                                
                                    <label for="nome"><strong>&nbsp&nbsp&nbspSobrenome&nbsp&nbsp</strong></label>
                                    <input type="text" id="nome" name="sbnome_responsavel" placeholder="Sobrenome" class="form-control formInicial" value="<?php echo $nome[1];?>"/>
                                ...
                                <div class="col-10 form-group mt-4" style="display: flex; align-items: center;"">
                                    ...
                                    <input type="text" id="nome" name="cargo" placeholder="Digite seu cargo" class="form-control formInicial" value="<?php echo $exibir->CH_CargoDoResponsavel?>"/>
                        
                                
                                    <label class="col-3" for="nome"><strong>&nbsp&nbsp&nbspTelefone p/ contato:</strong></label>
                                    <input type="text" id="nome" name="telefone_responsavel" placeholder="(00) 00000-0000" class="form-control formInicial" value="<?php echo $exibir->CH_TelefoneResponsavel?>"/>
                            ...
                            <div class="col-1 offset-sm-9" style="margin-top:3%;">
                                ...
                                <a href=""><button name="btn_editar" class="btn btn-primary">Editar</button></a>
